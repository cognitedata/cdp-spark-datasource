...
| `maxParallelRequests` | The maximum number of requests send to CDF in parallel **per partition**. Reduce this number if running into rate limiting issues. Default: 200                                                                                                                                                                                                                                        |                                            |
