...
package cognite.spark.v1.wdl
  ...
  /**
   * Filter depth measurements that intersects a hole section with a chosen bit size or hole size.
   */
case class DepthMeasurementHoleSectionFilter(
  bitSize: Option[Distance] = None,
  holeSize: Option[Distance] = None
)
