...
object NptAggregateEnum extends Enumeration {
    type NptAggregateEnum = NptAggregateEnum.Value
    val NptCode = Value("npt code")
    val NptCodeDetail = Value("npt code detail")
}
