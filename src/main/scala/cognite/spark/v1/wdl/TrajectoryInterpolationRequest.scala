...
case class TrajectoryInterpolationRequest(
  wellboreId: Identifier,
  measuredDepths: Seq[Double],
  measuredDepthUnit: DistanceUnit,
  trueVerticalDepthUnit: Option[DistanceUnit] = None
)
