...
package cognite.spark.v1.wdl
  ...
  /**
   * No Drilling Surprises Event
   */
case class Nds(
  /* The CDF asset external ID of the wellbore the event is associated to. The asset must have been ingested as a wellbore with the same source as this NDS event. */
  wellboreAssetExternalId: String,
  /* The matching id of the wellbore related to NDS event. */
  wellboreMatchingId: String,
  source: EventSource,
  /* Textual description of the event. */
  description: Option[String] = None,
  holeDiameter: Option[Distance] = None,
  holeStart: Option[NdsHoleStart] = None,
  holeEnd: Option[NdsHoleEnd] = None,
  holeTop: Option[NdsHoleTop] = None,
  holeBase: Option[NdsHoleBase] = None,
  /* Type of NDS risk. */
  riskType: Option[String] = None,
  /* Subtype of NDS risk. */
  subtype: Option[String] = None,
  /* Severity of the NDS event. The value should be between 0-5 where 5 is the highest. */
  severity: Option[Int] = None,
  /* Probability of the NDS. The value should be between 0-5 where 5 is the highest. */
