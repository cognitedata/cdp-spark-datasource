...
case class WellMergeDetailsFieldSources(
  name: Option[AssetSource] = None,
  description: Option[AssetSource] = None,
  country: Option[AssetSource] = None,
  quadrant: Option[AssetSource] = None,
  spudDate: Option[AssetSource] = None,
  block: Option[AssetSource] = None,
  field: Option[AssetSource] = None,
  operator: Option[AssetSource] = None,
  wellType: Option[AssetSource] = None,
  license: Option[AssetSource] = None,
  waterDepth: Option[AssetSource] = None,
  wellhead: Option[AssetSource] = None
)
