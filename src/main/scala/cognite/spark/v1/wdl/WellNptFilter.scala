...
package cognite.spark.v1.wdl
   ...
   */
case class WellNptFilter(
  /* Set to false to filter on non-existence of particular npt events */
  exists: Option[Boolean] = None,
  measuredDepth: Option[DistanceRange] = None,
  duration: Option[DurationRange] = None,
  nptCodes: Option[ContainsAllOrAny] = None,
  nptCodeDetails: Option[ContainsAllOrAny] = None
)
