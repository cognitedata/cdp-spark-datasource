...
package cognite.spark.v1.wdl
  ...
  /**
   * Data from a depth measurement sequence
   */
case class DepthMeasurementData(
  id: Long,
  source: SequenceSource,
  depthColumn: DepthIndexColumn,
  depthUnit: DistanceUnit,
  /* Column information in order given by data */
  columns: Seq[DepthMeasurementDataColumn],
  /* List of row information */
  rows: Seq[DepthMeasurementRow],
