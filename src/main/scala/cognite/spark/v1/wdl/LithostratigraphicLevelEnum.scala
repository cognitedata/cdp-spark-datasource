...
package cognite.spark.v1.wdl
  ...
  /**
   * Lithostratigraphic classifier.
   */

object LithostratigraphicLevelEnum extends Enumeration {
    type LithostratigraphicLevelEnum = LithostratigraphicLevelEnum.Value
    val Bed = Value("bed")
    val Member = Value("member")
    val Formation = Value("formation")
