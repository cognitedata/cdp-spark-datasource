...
package cognite.spark.v1.wdl
   ...
   * Hole section
   */
case class HoleSection(
  source: GeneralExternalId,
  /* Name for the Hole Section. */
  name: String,
  /* Hole size of the hole section in hole section group hole size unit. */
  holeSize: Option[Double] = None,
  /* Bit size of the hole section in hole section group bit size unit. */
  bitSize: Option[Double] = None,
  /* The timestamp in milliseconds since the epoch (Jan 1, 1970) for when the hole sections was started. */
  startTime: Option[Long] = None,
  /* The timestamp in milliseconds since the epoch (Jan 1, 1970) for when the hole sections was completed. */
  endTime: Option[Long] = None,
  /* Top of the hole section - shallowest point by measured depth. */
  topMeasuredDepth: Option[Double] = None,
  /* Base of the hole section - deepest point by measured depth. */
  baseMeasuredDepth: Option[Double] = None
)
