...
import cognite.spark.v1.wdl.DepthMeasurementValueTypeEnum._

  /**
   * Column information returned on data requests
   */
case class DepthMeasurementDataColumn(
  /* User provided column identifier (Unique for a given sequence) */
  externalId: String,
  /* Human readable name of the column */
  name: Option[String] = None,
  measurementType: String,
  /* Unit for the measurement type */
  unit: String,
  valueType: DepthMeasurementValueTypeEnum
)
