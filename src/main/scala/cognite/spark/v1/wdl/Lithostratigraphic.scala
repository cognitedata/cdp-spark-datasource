...
import cognite.spark.v1.wdl.LithostratigraphicLevelEnum._

  /**
   * A lithostratigraphic defines the classification of a well top surface.
   */
case class Lithostratigraphic(
