...
case class DeleteWells(
  items: Seq[AssetSource],
  /* If set to true, it will delete associated wellbores, measurements, NPT/NDS etc. If set to false, it will fail if one of the wells have associated wellbores. */
