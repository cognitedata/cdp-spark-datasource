...
import cognite.spark.v1.wdl.DistanceUnitEnum._
  ...
  /**
   * Dogleg severity unit. Eg. degrees per 30 meters or degrees per 100 feet.
   */
case class DoglegSeverityUnit(
  angleUnit: AngleUnitEnum,
  distanceUnit: DistanceUnitEnum,
  distanceInterval: Option[Double] = None
)
