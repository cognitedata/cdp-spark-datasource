...
case class NdsFilter(
  holeStart: Option[NdsFilterHoleStart] = None,
  holeEnd: Option[NdsFilterHoleEnd] = None,
  holeTop: Option[DistanceRange] = None,
  holeBase: Option[DistanceRange] = None,
  probabilities: Option[Seq[Int]] = None,
  severities: Option[Seq[Int]] = None,
  riskType: Option[PropertyFilter] = None,
  subtype: Option[PropertyFilter] = None,
