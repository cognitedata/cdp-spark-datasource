...
case class DeleteSources(
  items: Seq[Source],
  /* **Deprecated**. Please delete the sources with `wells/delete` first.  If set to true, it will delete all data under the source. If set to false, it will fail if one of the sources has any wells. */
