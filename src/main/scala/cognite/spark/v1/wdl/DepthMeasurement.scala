...
case class DepthMeasurement(
  /* The CDF asset external ID of the wellbore. The asset must have been ingested as a wellbore with the same source as this NPT event. */
  wellboreAssetExternalId: String,
  /* The matching id of the wellbore related to depth measurement. */
  wellboreMatchingId: String,
  source: SequenceSource,
  depthColumn: DepthIndexColumn,
  datum: Option[Datum] = None,
  columns: Seq[DepthMeasurementColumn],
  /* Run number if the depth measurement represents a well log. */
  run: Option[String] = None,
  /* Producer that made the data in the depth measurement. */
  ...
  depthRange: Option[DistanceRange] = None
)
