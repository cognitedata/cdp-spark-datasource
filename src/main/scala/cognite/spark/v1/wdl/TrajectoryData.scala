...
case class TrajectoryData(
  wellboreAssetExternalId: String,
  /* The matching id of the wellbore related to trajectory data. */
  ...
  doglegSeverityUnit: DoglegSeverityUnit,
  /* Indicates whether the dogleg severities in this trajectory were computed by the well service (true), or whether it was provided during ingestion (false) */
  doglegSeverityIsComputed: Boolean,
  rows: Seq[TrajectoryDataRow]
)
