...
package cognite.spark.v1.wdl
  ...
  /**
   * Filter on wells that have wellbores passing through a list of surfaces.
   */
case class WellTopFilter(
  /* Set to false to filter on wellbores that do not pass through the specified surfaces. If no surfaces are specified then only wellbores that are not associated with any surface are returned.  */
  exists: Option[Boolean] = None,
  surfaceNames: Option[ContainsAllOrAny] = None
)
