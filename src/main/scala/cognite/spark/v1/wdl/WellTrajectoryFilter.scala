...
package cognite.spark.v1.wdl
  ...
  /**
   * Filter on wellbores that have an associated trajectory only. Optionally, filter on wellbores that have a trajectory between minDepth and maxDepth
   */
case class WellTrajectoryFilter(
  maxMeasuredDepth: Option[DistanceRange] = None,
  maxTrueVerticalDepth: Option[DistanceRange] = None,
  maxInclination: Option[AngleRange] = None,
  maxDoglegSeverity: Option[DoglegSeverityRange] = None
)
