...
import cognite.spark.v1.wdl.DistanceUnitEnum._
  ...
  /**
   * The depth where the sidetrack started. This only makes sense if this wellbore is a sidetrack and has a parent wellbore.
   */
case class WellboreKickoffMeasuredDepth(
