...
package cognite.spark.v1.wdl
  ...
  /**
   * unit to represent an angle
   */

object AngleUnitEnum extends Enumeration {
    type AngleUnitEnum = AngleUnitEnum.Value
    val Degree = Value("degree")
    val Radian = Value("radian")
}
