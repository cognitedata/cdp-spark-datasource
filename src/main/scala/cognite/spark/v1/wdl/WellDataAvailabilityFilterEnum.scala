...
object WellDataAvailabilityFilterEnum extends Enumeration {
    type WellDataAvailabilityFilterEnum = WellDataAvailabilityFilterEnum.Value
    val Npt = Value("npt")
    val Nds = Value("nds")
    val Trajectories = Value("trajectories")
    val DepthMeasurements = Value("depthMeasurements")
    val Casings = Value("casings")
    val HoleSections = Value("holeSections")
    val TimeMeasurements = Value("timeMeasurements")
    val WellTops = Value("wellTops")
}
