...
package cognite.spark.v1.wdl
  ...
  /**
   * Filter rig operations with start time within a given time range.
   */
case class RigOperationFilterStartTime(
  /* Epoch timestamp in milliseconds when time range started. */
  min: Option[Long] = None,
  /* Epoch timestamp in milliseconds when time range ended. */
