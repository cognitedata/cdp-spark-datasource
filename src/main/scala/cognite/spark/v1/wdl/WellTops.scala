...
import cognite.spark.v1.wdl.PhaseEnum._
  ...
  /**
   * A collection of well tops for a given wellbore.
   */
case class WellTops(
  /* External ID for the wellbore asset the well tops are associated with. Source for the wellbore and for the well tops must be the same. */
  wellboreAssetExternalId: String,
  /* The matching id of the wellbore containing these lithostratigraphic units. */
  wellboreMatchingId: String,
  /* The name of the wellbore containing these lithostratigraphic units. */
  wellboreName: String,
  source: SequenceSource,
  measuredDepthUnit: DistanceUnitEnum,
  trueVerticalDepthUnit: DistanceUnitEnum,
  phase: Option[PhaseEnum] = None,
  /* If true, this is the _definitive_ well tops for the wellbore it is associated with. A wellbore can at any single time only have one definitive well tops. When well tops are used as a proxy for depth, only definitive well tops are used. */
  isDefinitive: Boolean,
  tops: Seq[WellTopSurface]
)
