...
package cognite.spark.v1.wdl
  ...
  /**
   * Describes a lithostratigraphic unit encountered in the wellbore
   */
case class WellTopSurfaceIngestion(
  /* The name of the lithostratigraphic unit */
  name: String,
  /* The measured depth of the top of the lithostratigraphic unit */
  topMeasuredDepth: Double,
  /* The measured depth of the base of the lithostratigraphic unit. */
  baseMeasuredDepth: Option[Double] = None,
  lithostratigraphic: Option[Lithostratigraphic] = None,
  chronostratigraphic: Option[Chronostratigraphic] = None
)
