...
package cognite.spark.v1.wdl
  ...
  /**
   * Specifies filtering parameters for well tops
   */
case class WellTopsFilter(
  /* Limit results to following wellbores */
  wellboreIds: Seq[Identifier],
  /* Specifies if the query is to return only definitive or not. If value is not set, then all well tops are returned. */
