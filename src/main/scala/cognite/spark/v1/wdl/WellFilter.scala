...
case class WellFilter(
  quadrant: Option[PropertyFilter] = None,
  region: Option[PropertyFilter] = None,
  block: Option[PropertyFilter] = None,
  field: Option[PropertyFilter] = None,
  operator: Option[PropertyFilter] = None,
  wellType: Option[PropertyFilter] = None,
  license: Option[PropertyFilter] = None,
  sources: Option[Seq[String]] = None,
  waterDepth: Option[DistanceRange] = None,
  datum: Option[DistanceRange] = None,
  spudDate: Option[DateRange] = None,
  polygon: Option[PolygonFilter] = None,
  trajectories: Option[WellTrajectoryFilter] = None,
  depthMeasurements: Option[WellDepthMeasurementFilter] = None,
  timeMeasurements: Option[WellTimeMeasurementFilter] = None,
  npt: Option[WellNptFilter] = None,
  nds: Option[WellNdsFilter] = None,
  wellTops: Option[WellTopFilter] = None,
  casings: Option[WellCasingFilter] = None,
  holeSections: Option[WellHoleSectionFilter] = None,
  dataAvailability: Option[WellDataAvailabilityFilter] = None
)
