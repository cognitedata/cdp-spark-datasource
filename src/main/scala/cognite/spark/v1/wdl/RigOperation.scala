...
package cognite.spark.v1.wdl
  ...
  /**
   * Rig Operations record
   */
case class RigOperation(
  /* The CDF asset external ID of the wellbore where the operation took place. The asset must have been ingested as a wellbore with the same source name as this Rig Operation. */
  wellboreAssetExternalId: String,
  /* The matching id of the wellbore related to operation. */
  wellboreMatchingId: String,
  source: RigOperationSource,
  /* The name of the rig. */
  rigName: String,
  /* Epoch timestamp in milliseconds for when the operation started. */
  startTime: Option[Long] = None,
  /* Epoch timestamp in milliseconds for when the operation ended. */
