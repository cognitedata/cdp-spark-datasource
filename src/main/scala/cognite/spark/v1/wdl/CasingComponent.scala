...
case class CasingComponent(
  minInsideDiameter: Option[CasingComponentMinInsideDiameter] = None,
  maxOutsideDiameter: Option[CasingComponentMaxOutsideDiameter] = None,
  topMeasuredDepth: Option[CasingComponentTopMeasuredDepth] = None,
  baseMeasuredDepth: Option[CasingComponentBaseMeasuredDepth] = None,
  /* Classification of the material used in the casing component. For example L-80, or J-55.  */
  grade: Option[String] = None,
  /* Name of the casing connection */
  connectionName: Option[String] = None,
  /* Number of component joints */
  joints: Option[Int] = None,
  /* Casing component description */
  description: Option[String] = None,
  /* Casing component manufacturer */
  manufacturer: Option[String] = None,
  /* Casing component type */
  typeCode: Option[String] = None,
  linearWeight: Option[LinearWeight] = None
)
