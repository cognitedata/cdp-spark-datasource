...
case class DepthMeasurementFilter(
  /* Filter depth measurements that contains columns with one of the given measurement types. */
  measurementTypes: Option[Seq[String]] = None,
  /* Filter depth measurements that belong to one of the given wellbores. */
  wellboreIds: Option[Seq[Identifier]] = None,
  holeSections: Option[DepthMeasurementHoleSectionFilter] = None,
  wellTops: Option[DepthMeasurementWellTopsFilter] = None
)
