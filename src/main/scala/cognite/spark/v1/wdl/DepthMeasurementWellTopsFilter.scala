...
package cognite.spark.v1.wdl
  ...
  /**
   * Filter depth measurements that intersects one of the given well tops. Only available in alpha. 
   */
case class DepthMeasurementWellTopsFilter(
  surfaceNames: Option[DepthMeasurementWellTopsFilterSurfaceNames] = None
)
