...
package cognite.spark.v1.wdl
  ...
  /**
   * No Drilling Surprises Filter
   */
case class WellNdsFilter(
  /* Set to false to filter on non-existence of particular nds events */
  exists: Option[Boolean] = None,
  severities: Option[ContainsAllOrAnyInt] = None,
  probabilities: Option[ContainsAllOrAnyInt] = None,
  riskTypes: Option[ContainsAllOrAny] = None
)
