...
package cognite.spark.v1.wdl
  ...
  /**
   * Either measured depth or true vertical depth
   */

object DepthIndexTypeEnum extends Enumeration {
    type DepthIndexTypeEnum = DepthIndexTypeEnum.Value
    val MeasuredDepth = Value("measured depth")
    val TrueVerticalDepth = Value("true vertical depth")
}
