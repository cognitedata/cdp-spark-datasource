...
case class WellboreMergeRules(
  ...
  parents: Seq[String],
  wellTops: Seq[String],
  holeSections: Option[Seq[String]] = None,
  trajectories: Option[Seq[String]] = None,
  casings: Option[Seq[String]] = None,
  totalDrillingDays: Option[Seq[String]] = None,
  kickoffMeasuredDepth: Option[Seq[String]] = None
)
