...
package cognite.spark.v1.wdl
  ...
  /**
   * A list of well top surfaces names. Alpha version, only containsAny is supported.
   */
case class DepthMeasurementWellTopsFilterSurfaceNames(
  /* match on all of the strings */
  containsAll: Option[Seq[String]] = None,
  /* match on any of the strings */
  containsAny: Option[Seq[String]] = None
)
