...
package cognite.spark.v1.wdl
  ...
  /**
   * Specifies filtering parameters for hole sections
   */
case class HoleSectionFilter(
  /* Filter hole sections that are related to one of given wellbores. */
  wellboreIds: Option[Seq[Identifier]] = None,
  bitSize: Option[Distance1] = None,
  holeSize: Option[Distance2] = None,
  topMeasuredDepth: Option[DistanceRange1] = None,
  baseMeasuredDepth: Option[DistanceRange2] = None,
  startTime: Option[DistanceRange3] = None,
  endTime: Option[DistanceRange4] = None,
  /* Specifies if the query is to return only definitive or not. If value is not set, then all hole sections are returned. */
