...
package cognite.spark.v1.wdl
   ...
   */
case class RigOperationFilter(
  /* Filter rig operations by rig names. */
  rigNames: Option[Seq[String]] = None,
  startTime: Option[RigOperationFilterStartTime] = None,
  endTime: Option[RigOperationFilterEndTime] = None,
  /* Filter rig operations that belong to one of the given wellbores. */
