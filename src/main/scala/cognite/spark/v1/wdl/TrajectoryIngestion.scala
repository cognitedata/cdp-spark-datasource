...
import cognite.spark.v1.wdl.AngleUnitEnum._
import cognite.spark.v1.wdl.DistanceUnitEnum._
import cognite.spark.v1.wdl.PhaseEnum._

case class TrajectoryIngestion(
  /* The CDF asset external ID of the wellbore this trajectory is associated with. The asset must have been ingested as a wellbore with the same source as this trajectory. */
  wellboreAssetExternalId: String,
  source: SequenceSource,
  `type`: Option[String] = None,
  measuredDepthUnit: DistanceUnitEnum,
  inclinationUnit: AngleUnitEnum,
  azimuthUnit: AngleUnitEnum,
  doglegSeverityUnit: Option[DoglegSeverityUnit] = None,
  phase: Option[PhaseEnum] = None,
  rows: Seq[TrajectoryIngestionRow]
)
