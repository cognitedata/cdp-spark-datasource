...
case class DepthMeasurementDataRequest(
  sequenceExternalId: String,
  measuredDepth: Option[DistanceRange] = None,
  depthUnit: Option[DistanceUnit] = None,
  measurementTypes: Option[Seq[String]] = None,
  columnExternalIds: Option[Seq[String]] = None,
  topSurfaceName: Option[String] = None,
