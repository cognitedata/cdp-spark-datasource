...
import cognite.spark.v1.wdl.ExternalIdTypeEnum._

  /**
   * A source external ID for an arbitrary resource in CDF.
   */
case class SourceExternalId(
  /* An identifier for a CDF resource. */
  externalId: String,
  `type`: ExternalIdTypeEnum,
  /* Name of the source this external ID belongs to. */
  sourceName: String
)
