...
package cognite.spark.v1.wdl
  ...
  /**
   * Filter on wells that have this type of measurement available.
   */
case class WellDepthMeasurementFilter(
  measurementTypes: Option[ContainsAllOrAnyMeasurementType] = None,
  measuredDepth: Option[DistanceRange] = None,
  trueVerticalDepth: Option[DistanceRange] = None
)
