...
package cognite.spark.v1.wdl
  ...
  /**
   * The distance between the mean sea level (MSL) and the vertical reference point of the wellbore. Most often, this reference point is the rotary table or the kelly bushing.
   */
case class DatumAllOf(
