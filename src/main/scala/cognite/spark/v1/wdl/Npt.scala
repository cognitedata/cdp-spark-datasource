...
package cognite.spark.v1.wdl
  ...
  /**
   * Non Productive Time Event
   */
case class Npt(
  /* The CDF asset external ID of the wellbore the event is associated to. The asset must have been ingested as a wellbore with the same source as this NPT event. */
  wellboreAssetExternalId: String,
  /* The matching id of the wellbore related to NPT event. */
  wellboreMatchingId: String,
  /* The NPT code to identify event. */
  nptCode: Option[String] = None,
  /* The more detailed NPT code that identifies the event. */
  nptCodeDetail: Option[String] = None,
  /* The level of non-productive time for the activity. The NPT level must be one of: \"0\", \"1\", \"2\", \"3\", \"4\", or \"5\". */
  nptLevel: Option[String] = None,
  source: EventSource,
  /* Description of the NPT event. */
  ...
  /* The time the depth measurement completed. The number of milliseconds since 00:00:00 Thursday, 1 January 1970, Coordinated Universal Time (UTC), minus leap seconds. */
  endTime: Option[Long] = None,
  measuredDepth: Option[NptMeasuredDepth] = None,
  /* Duration (hours) of the NPT event.. */
  duration: Option[Double] = None,
  /* Root cause for the NPT event. */
  rootCause: Option[String] = None,
  /* Location of NPT event. */
  location: Option[String] = None,
  /* Subtype of NPT event. */
