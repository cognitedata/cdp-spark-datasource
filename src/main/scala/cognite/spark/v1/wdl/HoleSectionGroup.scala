...
import cognite.spark.v1.wdl.DistanceUnitEnum._
import cognite.spark.v1.wdl.PhaseEnum._

  /**
   * Hole Section Groups ingestion
   */
case class HoleSectionGroup(
  /* Name of the source for the hole section group. */
  sourceName: String,
  /* External ID for the wellbore asset this hole section group is associated with. Source for the wellbore and for the hole section group must be the same. */
  wellboreAssetExternalId: String,
  /* The matching id of the wellbore this hole section group is associated with. */
  wellboreMatchingId: String,
  measuredDepthUnit: DistanceUnitEnum,
  sizeUnit: DistanceUnitEnum,
  /* A unique identifier for the hole section group. This id will be used to reference this hole section group. */
  externalId: String,
  phase: Option[PhaseEnum] = None,
  /* Describes if the hole section group is definitive. A definitive hole section group is a group that contains information about the actual hole section for a given wellbore. */
  isDefinitive: Option[Boolean] = None,
  /* A list of hole sections for this group. */
  sections: Seq[HoleSection]
)
