...
package cognite.spark.v1.wdl
   ...
   * NPT events Filter
   */
case class NptFilter(
  measuredDepth: Option[DistanceRange] = None,
  duration: Option[DurationRange] = None,
  nptCode: Option[PropertyFilter] = None,
  nptCodeDetail: Option[PropertyFilter] = None,
  rootCause: Option[PropertyFilter] = None,
  location: Option[PropertyFilter] = None,
