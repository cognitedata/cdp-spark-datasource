...
package cognite.spark.v1.wdl
  ...
  /**
   * A single casing string/assembly of a larger casing schematic
   */
case class CasingAssembly(
  minInsideDiameter: CasingAssemblyMinInsideDiameter,
  minOutsideDiameter: CasingAssemblyMinOutsideDiameter,
  maxOutsideDiameter: CasingAssemblyMaxOutsideDiameter,
  originalMeasuredDepthTop: CasingAssemblyOriginalMeasuredDepthTop,
  originalMeasuredDepthBase: CasingAssemblyOriginalMeasuredDepthBase,
  /* Type of casing assembly. Examples: Intermediate casing, production casing, production liner, etc. */
  `type`: Option[String] = None,
  /* Report description of the casing assembly */
  reportDescription: Option[String] = None,
  sectionTypeCode: Option[String] = None,
  cementing: Option[CasingCementing] = None,
  components: Option[Seq[CasingComponent]] = None
)
